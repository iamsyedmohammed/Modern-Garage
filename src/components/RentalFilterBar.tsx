...
const RentalFilterBar: React.FC<RentalFilterBarProps> = ({ brands = [], bodyTypes = [] }) => {
    ...
    <div className="bg-white border border-grayCustom-border rounded-3xl p-8 mb-16 shadow-xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-2 space-y-3">
          <label className="text-xs font-black uppercase tracking-[0.1em] text-grayCustom-text">Search Rentals</label>
        ...
        {/* Max Daily Price */}
        <div className="space-y-3">
          <label className="text-xs font-black uppercase tracking-[0.1em] text-grayCustom-text">Max Price / Day</label>
          <select 
            id="rental-max-price-select"
            value={maxPrice}
            onChange={(e) => setMaxPrice(e.target.value)}
            className="w-full bg-grayCustom-light border-2 border-transparent rounded-xl px-4 py-3.5 text-sm font-bold focus:border-primary/30 focus:bg-white outline-none transition-all cursor-pointer"
          >
            <option value="">Any Price</option>
            <option value="50">$50 / day or less</option>
            <option value="100">$100 / day or less</option>
            <option value="150">$150 / day or less</option>
            <option value="200">$200 / day or less</option>
            <option value="300">$300 / day or less</option>
          </select>
        </div>
