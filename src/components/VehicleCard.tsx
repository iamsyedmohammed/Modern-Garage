    ...
    <div className="group relative bg-white border border-grayCustom-border rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col h-full">
      ...
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-2">
          ...
          <span className="px-3 py-1 bg-black text-white text-[10px] font-bold uppercase tracking-wider rounded-md">
            {condition}
          </span>
          {status === 'Sold' ? (
            <span className="px-3 py-1 bg-gray-500 text-white text-[10px] font-bold uppercase tracking-wider rounded-md">
              Sold
            </span>
          ) : (
